    -- Create the missing grant_user_role function for Jobsy AI
    -- This script fixes the PGRST202 error by creating the missing database function
    -- This version is simpler and doesn't conflict with existing RLS settings
    ...
    -- Create the grant_user_role function (this is the main fix for PGRST202 error)
